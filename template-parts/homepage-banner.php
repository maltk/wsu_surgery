<?php
/**
 * Template part for displaying the banner
 *
    ...
    <div class="banner">
        <div id="home-hero" class="bxslider">
            <section class="s1 home-hero-item">
                ...
                <div class="container">
                    <div class="col-lg-8 text-left col-md-12 col-sm-12 col-xs-12">
                        <h3>Department of Surgery App...</h3>
                        <h2>Streamline communications for department and community members.</h2>
                        <br><br>
                        <svg version="1.1" id="US_UK_Download_on_the" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            x="0px" y="0px" width="170px" height="auto" viewBox="0 0 135 40" enable-background="new 0 0 170 auto" xml:space="preserve">
                        <g>
            ...
            <section class="s3 home-hero-item">
                ...
                <div class="container">
                    <div class="col-lg-8 text-left col-md-12 col-sm-12 col-xs-12">
                        <h3>Simulation <em>is</em> the future of surgery.</h3>
                        <h2>We are actively involved in the research and development of simulation technologies both within the Department and in partnership...</h2>
                        <br>
                        <a class="btn btn-yellow btn-xlg" href="#">Learn More</a>
                    </div>
                </div>
